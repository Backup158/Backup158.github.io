...
3. Run the tools
    ...
    - Otherwise there will be unecessary differences and it won't help (but thanks for the effort)
4. Delete the contents of your fork (besides the README). This is so you can catch if a file was deleted.
5. Copy over the contents of the `output` folder into your fork repo
6. Upload it with git 
